...
namespace ChatBotApplication.Common.Behavior
{
    //Class này sẽ tự động chặn mọi Request đi qua MediatR để kiểm tra.
    // Class này đóng vai trò như Middleware nhưng nằm ở tầng Application
